...
// -----------------------------------------------------------------------------
// Zone 1 — Array Archipelago   (aa_01 ? aa_15)
// Zone 2 — String Shores       (ss_01 ? ss_15)
// Zone 3 — Loop Lagoon         (ll_01 ? ll_15)
//
// Progression rule:
...
export const ZONES = [
    ...
    nodes: [
      ...
      // -- Nodes 1–7: Easy ---------------------------------------------------
      {
        ...
        problem: {
          ...
          description:
            'Given an array of N integers, find and print the sum of all elements.',
          examples: [{ input: '5\n1 2 3 4 5', output: '15' }],
          constraints: ['1 = N = 105', '0 = arr[i] = 104'],
        },
      ...
      },
      {
        ...
        problem: {
          ...
          description:
            'Rearrange the array so elements alternate: small, large, small, large.',
          examples: [{ input: '5\n4 3 7 8 6', output: '3 7 4 8 6' }],
          constraints: ['1 = N = 105', 'All elements distinct'],
        },
        rewards:        { oneStarKP: 10, twoStarKP: 20, threeStarKP: 35 },
        starThresholds: { twoStarTimeMs: 250, threeStarTimeMs: 90 },
      },
      {
        ...
        problem: {
          ...
          description:
            'Given N-1 distinct integers in range [1, N], find the missing one.',
          examples: [{ input: '5\n1 2 4 5', output: '3' }],
          constraints: ['2 = N = 105'],
        },
        rewards:        { oneStarKP: 10, twoStarKP: 20, threeStarKP: 35 },
      ...
      },
      {
        ...
        problem: {
          ...
          description:
            'Sum both diagonals of an N×N matrix (centre element counted once).',
          examples: [{ input: '3\n1 2 3\n4 5 6\n7 8 9', output: '25' }],
          constraints: ['1 = N = 100'],
        },
        rewards:        { oneStarKP: 15, twoStarKP: 25, threeStarKP: 45 },
      ...
      },
      {
        ...
        problem: {
          ...
          constraints: ['1 = N = 105', '0 = height[i] = 104'],
        },
        rewards:        { oneStarKP: 15, twoStarKP: 25, threeStarKP: 45 },
        starThresholds: { twoStarTimeMs: 200, threeStarTimeMs: 80 },
      },
      {
        ...
        problem: {
          ...
          description:
            'Rearrange array to the lexicographically next permutation in-place.',
          examples: [{ input: '3\n1 2 3', output: '1 3 2' }],
          constraints: ['1 = N = 100'],
        },
        rewards:        { oneStarKP: 15, twoStarKP: 25, threeStarKP: 45 },
      ...
      // -- Node 15: Zone Boss -----------------------------------------------
      {
        ...
        problem: {
          ...
          description:
            'Given an N×M grid, find the minimum path sum from top-left to bottom-right moving only right or down.',
          examples: [{ input: '3 3\n1 3 1\n1 5 1\n4 2 1', output: '7' }],
        ...
        lootPool: [
          { itemId: 'title_arrayking', itemType: 'title',  dropChance: 0.4  },
          { itemId: 'border_gold',     itemType: 'border', dropChance: 0.25 },
        ],
      },
    ],
  },
  ...
  // --------------------------------------------------------------------------
  // ZONE 2 — String Shores   (unlocks after aa_15)
  // --------------------------------------------------------------------------
  {
    id:       'string_shores',
    name:     'String Shores',
    ...
    nodes: [
      ...
      },
      {
        ...
        problem: {
          ...
          description:
            'Print YES if the sentence contains every letter of the alphabet.',
          examples: [
      ...
      },
      {
        ...
        problem: {
          ...
          description:
            'Compress a string using run-length encoding (e.g. "aaabbbcc" ? "3a3b2c").',
      ...
      },
      {
        ...
        problem: {
          ...
          description:
            'Find the character that appears most frequently. Break ties alphabetically.',
      ...
      },
      {
        ...
        problem: {
          ...
          description:
            'Implement basic string compression. If compressed is not smaller, return original.',
      ...
      },
      {
        ...
        problem: {
          ...
          description:
            'Given S and goal, can S become goal after some rotations? YES or NO.',
      ...
      },
      {
        ...
        problem: {
          ...
          description:
            "Match pattern with string using '?' (any single char) and '*' (any sequence).",
          examples: [{ input: 'ba\nb*', output: 'YES' }],
      ...
      // -- Node 15: Zone Boss -----------------------------------------------
      {
        ...
        starThresholds: { twoStarTimeMs: 300, threeStarTimeMs: 120 },
        lootPool: [
          { itemId: 'title_stringlord', itemType: 'title',  dropChance: 0.4  },
  ...
  // --------------------------------------------------------------------------
  // ZONE 3 — Loop Lagoon   (unlocks after ss_15)
  // --------------------------------------------------------------------------
  {
    id:       'loop_lagoon',
    name:     'Loop Lagoon',
    ...
    nodes: [
      ...
      },
      {
        ...
        problem: {
          ...
          description:
            'Find the digital root: repeatedly sum digits until a single digit remains.',
      ...
      },
      {
        ...
        problem: {
          ...
          description:
            'Print a staircase pattern of N rows using right-aligned # symbols.',
      ...
      // -- Node 8: Mid-Boss -------------------------------------------------
      {
        ...
        problem: {
          ...
          description:
            'For N: if even divide by 2; if odd multiply by 3 and add 1. Count steps until reaching 1.',
      ...
      // -- Nodes 9–14: Medium -----------------------------------------------
      {
        ...
        problem: {
          ...
          description:
            'Find the index of target K in a sorted array. Print -1 if not found.',
          examples: [{ input: '5 3\n1 2 3 4 5', output: '2' }],
          constraints: ['1 = N = 105'],
        },
        rewards:        { oneStarKP: 15, twoStarKP: 25, threeStarKP: 45 },
      ...
      },
      {
        ...
        problem: {
          ...
          description:
            'Sort the array using bubble sort and count total swaps made.',
      ...
      },
      {
        ...
        problem: {
          ...
          description:
            'Return indices (1-indexed) of two numbers that sum to the target.',
      ...
      },
      {
        ...
        problem: {
          ...
          description:
            'Given a linked list represented as an array with a cycle at position P (-1 if none), detect and print the cycle start index.',
          examples: [{ input: '5 2\n1 2 3 4 5', output: '2' }],
          constraints: ['1 = N = 104'],
        },
        rewards:        { oneStarKP: 15, twoStarKP: 25, threeStarKP: 45 },
      ...
      },
      {
        ...
        problem: {
          ...
          description:
            'Perform a flood fill on an image starting at (sr, sc) with newColor.',
          examples: [
            { input: '3 3 1 1 2\n1 1 1\n1 1 0\n1 0 1', output: '2 2 2\n2 2 0\n2 0 1' },
          ],
      ...
      },
      {
        ...
        problem: {
          ...
          description:
            'Given array of max jump lengths, determine if you can reach the last index. YES or NO.',
      ...
      // -- Node 15: Zone Boss -----------------------------------------------
      {
        ...
        problem: {
          ...
          description:
            'Find the number of distinct paths from top-left to bottom-right of an N×M grid (only moving right or down). Output result mod 10? + 7.',
        ...
        starThresholds: { twoStarTimeMs: 300, threeStarTimeMs: 120 },
        lootPool: [
          { itemId: 'title_looplord', itemType: 'title', dropChance: 0.4 },
          { itemId: 'theme_matrix',   itemType: 'theme', dropChance: 0.2 },
        ],
      },
    ],
  },
