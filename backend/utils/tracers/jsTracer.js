...
//     try {
//         // 2. Instrument
//         const { code: instrumentedCode, scopeMap } = instrumentJs(userCode);
...
//     // This means each snapshot only captures variables that actually exist in scope,
//     // eliminating undefined TDZ noise completely.
...
//             case 'BlockStatement':
//                 // We do NOT push a new scope here — let, const are block-scoped
//                 // but we need to see them from the snapshot at end of declaration.
//                 // Acorn's VariableDeclarator will handle the declare() call above.
