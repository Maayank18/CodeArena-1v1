...
// THIS ALSO HANDLES THE CASE OF TIE BUT THE ABOVE CODE DOESNT 
import React, { useEffect, useState } from 'react';
import Navbar from '../components/Navbar';
import Sidebar from '../components/Sidebar';
import { format } from 'date-fns';
                        ...
                        {loading ? (
                            ...
                            <div className="space-y-3 md:space-y-4">
                                {history.map((match, idx) => {
                                    ...
                                    // ✅ FIXED: Logic for Status Display (Win, Loss, Draw, Disqualified)
                                    const isDisqualified = myData.statusText === "Disqualified";
                                    const isDraw = myData.statusText === "Draw"; // Check for Tie
