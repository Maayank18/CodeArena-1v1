...
// // Import the new large shield logo
...
//       {/* Header */}
//       <header className="flex items-center justify-between px-10 py-6 border-b border-[#3e3e42] bg-dark/80 backdrop-blur-lg sticky top-0 z-50">
//         <Logo />
...
//                 className="w-48 h-48 md:w-64 md:h-64 object-contain drop-shadow-[0_0_50px_rgba(74,238,136,0.3)]"
//             />
//         </div>
//         {/* ----------------------------- */}
