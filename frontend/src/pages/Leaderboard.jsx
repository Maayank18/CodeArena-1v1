...
//                             filteredPlayers.map((player, index) => {
//                                 const rank = index + 1;
//                                 // ✅ MODIFIED: Use 1000 as fallback and extract 'hex' for styling
...
//                                                     {player.username}
//                                                 </span>
//                                                 <span className={`text-[10px] sm:hidden ${color} opacity-90 truncate font-bold`}>
//                                                     {title}
//                                                 </span>
//                                             </div>
//                                         </div>
...
//                                         {/* Desktop Level Badge */}
//                                         <div className="col-span-2 hidden sm:flex justify-center">
//                                             {/* ✅ ENHANCED: Use the hex color for a subtle glow effect */}
//                                             <span 
//                                                 className={`text-[10px] sm:text-xs font-black px-3 py-1 rounded-full border bg-gray-800/50 ${color}`}
//                                                 style={{ borderColor: `${hex}44`, boxShadow: `0 0 10px ${hex}11` }}
//                                             >
//                                                 {title}
//                                             </span>
//                                         </div>
