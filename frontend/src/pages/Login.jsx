...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[var(--bg-primary)] p-4">
            <div className="bg-[var(--bg-secondary)] p-8 rounded-2xl w-full max-w-md border border-[var(--border-color)] shadow-2xl">
                <div className="flex justify-center mb-6"><Logo className="text-[var(--text-primary)]" /></div>
