        ...
        <div className="flex-1 flex flex-col items-center justify-center overflow-y-auto p-8">
            ...
            <div className="text-center space-y-6">
                <div className="relative inline-block">
                    ...
                    <div className="absolute -inset-1 rounded-lg bg-gradient-to-r from-blue-600 to-purple-400 opacity-60 blur-lg"></div>
                ...
                <div className="space-y-3 mt-8">
                    <h2 className="text-2xl font-bold text-blue-400 tracking-wide">COMING SOON</h2>
                 ...
                 {/* Visual separator */}
                 <div className="w-16 h-1.5 bg-blue-500/30 rounded-full mx-auto mt-8"></div>
            </div>
