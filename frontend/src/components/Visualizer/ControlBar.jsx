...
// import { Play, Pause, SkipBack, SkipForward, PlayCircle, RotateCcw } from 'lucide-react';
...
//     // Prevent slider from exceeding bounds
//     const handleSliderChange = (e) => {
//         const val = parseInt(e.target.value);
//         setCurrentStep(Math.min(val, totalSteps - 1));
//     };
...
//             <button 
//                 onClick={onRun}
//                 className="flex items-center gap-2 bg-green-600 hover:bg-green-500 text-white px-6 py-2 rounded-full font-bold transition-all shadow-lg active:scale-95"
//             >
//                 <PlayCircle size={20} />
//                 Visualize
//             </button>
...
//                     className="p-2 bg-blue-600 hover:bg-blue-500 text-white rounded shadow-md transition-colors w-10 flex justify-center"
//                 >
...
//                 <span className="text-xs font-mono text-gray-500 min-w-[50px]">
