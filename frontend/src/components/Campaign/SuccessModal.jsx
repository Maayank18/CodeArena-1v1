            ...
            {isOpen && (
                ...
                >
                    <motion.div
                        ...
                        className="bg-[#0a0c12] border border-gray-800/60 rounded-2xl w-full max-w-[420px] overflow-hidden shadow-2xl"
                    >
                        {/* Top glow band */}
                        ...
                        <div className={`px-6 pt-7 pb-4 text-center ${stars === 3 ? 'bg-gradient-to-b from-amber-950/25 to-transparent' : stars === 2 ? 'bg-gradient-to-b from-yellow-950/20 to-transparent' : 'bg-gradient-to-b from-emerald-950/15 to-transparent'}`}>
                            <motion.div
                        ...
                        <div className="px-6 pb-4 grid grid-cols-2 gap-3">
                            <motion.div
                                ...
                                className="bg-gray-900/60 border border-gray-800/50 rounded-xl p-3.5 text-center"
                            >
                                <div className="flex items-center justify-center gap-1 mb-1">
                                    <Zap size={13} className="text-accent" />
                                    <span className="text-[10px] text-gray-600 font-bold uppercase tracking-wider">KP Earned</span>
                                </div>
                            ...
                            >
                                <div className="flex items-center justify-center gap-1 mb-1">
                                    <span className="text-[10px] text-gray-600 font-bold uppercase tracking-wider">⚡ Avg Time</span>
                                </div>
                                <div className="text-2xl font-black text-blue-400">
                                    {time}<span className="text-sm text-blue-600">ms</span>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        <div className="px-6 pb-5 space-y-2">
                            {improved && (
                                <motion.div
                                    ...
                                    className="text-center py-2 bg-emerald-950/25 rounded-lg border border-emerald-800/35"
                                >
                                    <span className="text-sm text-emerald-400 font-bold">🎉 New Personal Best!</span>
                                </motion.div>
                            )}
                            ...
                            {newNodes.length > 0 && (
                                <motion.div
                                    ...
                                    className="text-center py-2 bg-accent/8 rounded-lg border border-accent/25 flex items-center justify-center gap-2"
                                >
                            ...
                            {loot && (
                                <motion.div
                                    ...
                                    className="text-center py-2.5 bg-amber-950/30 rounded-lg border border-amber-700/40"
                                >
                                    <div className="text-2xl mb-0.5">🎁</div>
                                    <p className="text-sm text-amber-300 font-bold">Loot Drop: {loot.itemId}!</p>
                                </motion.div>
                            )}
                        </div>
                        ...
                        >
                            <button
                                onClick={onViewMap}
                                className="flex-1 py-3 bg-gray-800 hover:bg-gray-700 border border-gray-700/60 text-white rounded-xl font-bold transition-all flex items-center justify-center gap-2 text-sm"
                            >
