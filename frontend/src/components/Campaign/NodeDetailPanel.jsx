...
//               <span className={`text-xs px-2 py-1 rounded border mt-1 inline-block ${DIFF_COLOR[difficulty]}`}>
//                 {difficulty}
//               </span>
//             </div>
...
//                 {[1,2,3].map(i => (
//                   <Star key={i} className={i<=stars ? 'text-yellow-400 fill-yellow-400' : 'text-gray-500'} size={16}/>
//                 ))}
//               </div>
//             ) : (
...
//             {node.starThresholds && (
//               <div>
//                 <p className="text-xs text-gray-500 mb-2">Star Thresholds</p>
//                 <div className="space-y-1 text-sm">
//                   <div>⭐ Pass all test cases</div>
//                   <div>⭐⭐ Avg time &lt; {node.starThresholds.twoStarTimeMs}ms</div>
//                   <div>⭐⭐⭐ Avg time &lt; {node.starThresholds.threeStarTimeMs}ms</div>
//                 </div>
//               </div>
//             )}
...
//             {isLocked ? (
//               <button disabled className="w-full py-3 bg-gray-700 rounded-xl">
//                 Locked
//               </button>
//             ) : (
//               <button
