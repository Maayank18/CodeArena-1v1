            ...
            {isOpen && (
                ...
                >
                    <motion.div
                        ...
                        className="relative aspect-square w-full max-w-md overflow-hidden rounded-[2rem] border border-amber-300/20 bg-[#07080d]/95 p-8 shadow-[0_30px_120px_rgba(0,0,0,0.65)]"
                    >
